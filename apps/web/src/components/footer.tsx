            ...
            >
              <div className="food-relative food-flex-1">
                ...
                <input
                  ...
                  className="food-w-full food-pl-10 food-pr-4 food-py-3 food-rounded-lg food-bg-gray-700 food-border food-border-gray-600 food-text-white food-placeholder-gray-400 focus:food-outline-none focus:food-ring-2 focus:food-ring-[#FF6B35] focus:food-border-transparent"
                />
              </div>
              <FoodButton
                type="submit"
